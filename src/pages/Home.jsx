...
const Home = () => {
    ...
    useEffect(() => {
        ...
        const GetProjects = async () => {
            const { data } = await axios.get(
                `${constants.api_endpoint}/projects`
            );
            setProjects(data);
        };
        GetProjects();
    ...
    return (
        <div
            className={`bg-zinc-900 min-h-screen text-white font-rubik bg-grid `}
        >
            <NavBar />
            ...
            <div className="flex w-full items-center justify-center flex-col">
                <div className="flex w-full items-center justify-center flex-col h-screen">
                    ...
                    <h3
                        className={`${
                            mode === "light" &&
                            "invert text-black hue-rotate-180"
                        }`}
                    >
                        <TypeAnimation
                    ...
                    <p className="text-center max-w-[17rem] md:max-w-[19rem]">
                        I’m a {new Date().getFullYear() - constants.birth_year}{" "}
                        year old front-end engineer based in{" "}
                        <a
                            target="_blank"
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 place-items-center">
                        <p className="text-start max-w-[20rem] mt-5 md:max-w-[25rem] lg:max-w-[380px] lg:text-lg">
                            I'm a self-taught software engineer and designer
                            from Shiraz, Iran. Specializing in MERN stack
                            development, I create robust web applications. With
                            a fusion of technical expertise and design
                            sensibilities, I craft visually stunning interfaces
                            for exceptional user experiences.
                        </p>
                        <div className="my-10 flex items-center justify-center">
                            {!loading ? (
                                <DiscordCard info={discord_data} />
                            ) : (
                                ""
                            )}
                        </div>
                ...
                >
                    ...
                    <p className="text-start max-w-[20rem] mt-5 md:max-w-[30rem] lg:max-w-[750px] lg:text-lg">
                        In my free time, I enjoy creating open source projects
                        on{" "}
                        <a
                        ...
                        , so I can learn from others and share what I know. In
                        total, all of my open sourced projects have earnt me{" "}
                        <strong>{stars}</strong> stars on GitHub, and{" "}
                        <strong>{forks}</strong> forks. Below are some of my
